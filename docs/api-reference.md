...
updated 2026-08-26. Nothing here is hand-invented; every path, field, type, and JSON
...
**Request body** (`application/json`, `PrescreenIn`):

| Field | Type | Required | Notes |
|---|---|---|---|
| `session_ref` | string | Y | Session Ref |
| `slip_code` | string or null | N | Slip Code |
| `recommended_department` | string | Y | Recommended Department |
| `complaint` | string or null | N | Complaint |
| `reason` | string or null | N | Reason |
| `vitals` | object or null | N | Vitals |
| `reasons` | array of string | N | Reasons |
...
### `GET /api/visits/{visit_id}/prescreen`
...
**Request body** (`application/json`, `PatientVitalsIn`):
