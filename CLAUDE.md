...
- Every LLM call and rules decision writes to `ai_inference_audit` (migration 013): trace API `GET /admin/sessions/{id}/trace`, aggregates `GET /admin/ai-metrics`, nurse-visible `disposition_reasons` with manual citations in reviews.
