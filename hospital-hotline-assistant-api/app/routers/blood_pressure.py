"""Blood-pressure endpoints: the Omron cuff device (fetch/watch/admin
pairing) and the session BP write-back with its hypertensive-crisis rest
window. The thermometer has its own router (``thermometer.py``)."""
