// forked from design-sync lib/source-kit.mjs — app repo, not a library: keep main.tsx (createRoot side effect), App.tsx, and route screens out of the synth entry
...
const NON_IMPL_RX = /\.(stories|test|spec)\.|\/main\.tsx$|\/App\.tsx$|\/pages\//;
