// forked from design-sync lib/dts.mjs — this repo's Bp/Criteria/DoctorSchedule*Manager exports are real React components; drop the *Manager suffix exclusion
...
export const isComponentName = (n) => !n.endsWith('Props') && !/^[A-Z][A-Z0-9_]+$/.test(n)
  && !/(?:Placements|Context)$/.test(n) && !/^use[A-Z]/.test(n);
